...
public class ProductosDao {
    ...
    public boolean RegistrarProductos(Productos pro){
        String sql = "INSERT INTO products (codigo, nombre, proveedor, stock, precio) VALUES (?,?,?,?,?) ";
    ...
    public void ConsultarProveedor(JComboBox proveedor){
        String sql = "SELECT nombre FROM provider";
        try{
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
            rs = ps.executeQuery();
    ...
    public boolean ModificarProductos(Productos pro){
        ...
        String sql = "UPDATE products SET codigo=?, nombre=?, proveedor=?, stock=?, precio=? WHERE id=?";
    ...
    public Productos BuscarPro(String cod){
        ...
        String sql = "SELECT * FROM products WHERE codigo = ?";
        try{
            con  = cn.getConnection();
            ps = con.prepareStatement(sql);
            ps.setString(1, cod);
